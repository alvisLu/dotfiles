...
# my scripts
[ -f "$HOME/git/dotfiles/diff-so-fancy/util.sh" ] && source $HOME/git/dotfiles/diff-so-fancy/util.sh
...
[ -f "$HOME/git/dotfiles/scripts/fzf/fzf-git-binding.zsh" ] && source $HOME/git/dotfiles/scripts/fzf/fzf-git-binding.zsh
